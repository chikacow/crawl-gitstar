...
### Xử lý đọc/ghi và tương tác với cơ sở dữ liệu
...
### Vấn đề trùng commit giữa các release
...
### Kết quả
Phiên bản này có tốc độ crawl nhanh hơn nhiều so với các phiên bản trước, nhờ việc triển khai đa luồng, đồng thời thời gian và lượng thông tin crawl được cũng gia tăng đáng kể nhờ cơ chế xoay vòng token Tuy nhiên, chính vì workload tăng đã làm lộ ra một số vấn đề của hệ thống, đặc biệt là vấn đề khi tương tác với cơ sở dữ liệu
...
# Tổng Quan Hiệu Năng Crawl

| Phiên bản | **Số liệu với 8 repo nhẹ**        |               |                         | **Số liệu với 40 repo tổng hợp** |              |                    |                  |
|-----------|------------------------------------|---------------|-------------------------|----------------------------------|--------------|--------------------|------------------|
|           | Tổng thời gian                    | TB mỗi repo   | Ước tính toàn bộ (5 000 repo) | Số lượng release | Số lượng commit | Thời gian mỗi repo | Tổng thời gian   |
| **ver2**  | 44.75 s                           | 5.59 s/repo   | 7.8 giờ                 | N/A                            | N/A          | N/A                | N/A              |
| **ver3**  | 3.90 s                            | 0.49 s/repo   | 0.7 giờ                 | 7 265                          | 2 338 144    | 31 s/repo          | 1 264 s          |

*8 repo đầu là những repo nhẹ, ít commit và release. Bộ 40 repo mang tính đại diện hơn, bao gồm cả những repo rất nặng như `facebook/react`, `nextjs`, v.v.*

**Lưu ý:** `ver2` không có số liệu cho 40 repo do hiệu năng kém, chưa tối ưu, và thường xuyên bị timeout MySQL khi crawl khối lượng lớn.
📄 License
MIT License © 2025
